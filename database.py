...
class weather_database:
    ...
    def insert(self, ambient_temperature, barometric_pressure, humidity, ground_temperature, vis_light, ir_light, uv_index, wind_direction, wind_speed, wind_gust_speed, rainfall, created = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")):
